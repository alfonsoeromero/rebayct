...
public class BNaiveBayes {
    ...
    public static void main(String args[]) {
        BNaiveBayes  mn = new BNaiveBayes ();
        
        // arguments processing
        mn.processArguments(args);
        
        // class initialization
        BIMNaiveBayes naive = new BIMNaiveBayes(mn.classIndexFileName);
        ...
        try {
            ...
            while (in.ready()) {
                ...
                /*
                for (Map.Entry<Integer, Double> mp : list.entrySet())
                ...
                for (Map.Entry<Integer, Double> entry: lst) {
                    ...
                    sb.append(id.getId()).append(entry.getKey()).append(" ").append(i).append(" ").append(entry.getValue()).append("\n");
                    ++i;
                }
